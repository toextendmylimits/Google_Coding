...
|[2101. Detonate the Maximum Bombs](https://leetcode.com/problems/detonate-the-maximum-bombs) | Graph BFS/DFS| 23 | 01/12 | YES | Should memorize both DFS and BFS. Never use continue in a if not inside loop. Often should use return in a function
